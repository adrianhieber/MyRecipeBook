...
\titlespacing*{\subsection}{0pt}{0.6cm}{0.25cm}
...
\renewcommand{\preparation}[1]{%
  \def\xcb@preparation{%
    {\bfseries\large\color{Cocoa}\xcb@name@prephead}\par\vspace{-1em}
...
\renewcommand{\ingredients}[2][\empty]{%
  ...
  \def\xcb@ingredients{%
    {\bfseries\large\color{Cocoa}\xcb@name@inghead}\par\vspace{-1em}
    {\color{Sage}\rule{\linewidth}{.7pt}}\par\vspace{.35em}
